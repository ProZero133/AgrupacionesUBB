...
module.exports = function(fastify, options, done) {
  ...
  fastify.get('/administracionderoles/:id_agr', { preHandler: [isAdmin] },ObtenerUsuariosdeAgrupacion); // Devuelve los usuarios que pertenecen a una agrupacion en especifico
  ...
  fastify.put('/administracionderoles/:id_agr/:rut', { preHandler: [isAdmin] },CambiarRoldeUsuario); // Cambia el rol de un usuario en una agrupacion
