...
const {ObtenerActividadesPorAgrupacion, ObtenerActividadPorID, ObtenerActividades,
   crearActividad, updateActividad, eliminarActividad, programarActividad,
    participarActividad, ObtenerCuposRestantes} = require('../controllers/actividad.controller.js');
...
module.exports = function(fastify, options, done) {
  ...
  fastify.get('/cuposRestantes/:id_act', ObtenerCuposRestantes);
