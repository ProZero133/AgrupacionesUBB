        ...
        <v-card class="mx-auto px-6 py-8" max-width="800">
            <v-form @submit.prevent="CreaTag" fast-fail class="form" ref="formulario">
                <v-row>
                    ...
                    <v-col cols="4">
                        <v-text-field class="nombreTag" v-model="nombre_tag" label="Nombre del tag" clearable counter
                            required></v-text-field>
                    </v-col>

                    <v-col cols="8">
                        <v-text-field class="rut" v-model="rut" label="Rut" clearable counter required></v-text-field>
                    </v-col>

                    <v-col cols="4">
                        <v-btn class="form-submit" type="submit" color="#2CA2DC">Crear Tag</v-btn>
                    </v-col>
